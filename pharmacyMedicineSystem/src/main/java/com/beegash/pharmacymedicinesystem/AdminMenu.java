...
public class AdminMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSellMedicine1 = new javax.swing.JButton();
        btnShowStatus = new javax.swing.JButton();
        btnClear = new javax.swing.JButton();
        txtAssignmet = new javax.swing.JTextField();
        ...
        btnSellMedicine1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnSellMedicine1.setText("User Management");
        btnSellMedicine1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSellMedicine1ActionPerformed(evt);
            }
        });

        btnShowStatus.setText("Show Status Report");
        ...
        jLabel6.setText("Give Assignment:");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(btnSellMedicine, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                                    .addComponent(btnMedicineList, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(btnSellMedicine1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(txtAssignmet, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtAssignmet, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnSend))
                .addGap(18, 18, 18)
    ...
    private void btnSellMedicine1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSellMedicine1ActionPerformed
        // TODO add your handling code here:
        UserManagement user = new UserManagement();
        user.setVisible(true);
    }//GEN-LAST:event_btnSellMedicine1ActionPerformed

    private void btnShowStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowStatusActionPerformed
        // TODO add your handling code here:
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\fener\\OneDrive\\Masaüstü\\PharmacyMedicineReport\\StatusReport.txt"))) {
            StringBuilder metin = new StringBuilder();
            String satir;
            while ((satir = reader.readLine()) != null) {
                metin.append(satir).append("\n");
            }
            JOptionPane.showMessageDialog(null, metin.toString(), "Status Report", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearActionPerformed
        // TODO add your handling code here:
         try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\\\Users\\\\fener\\\\OneDrive\\\\Masaüstü\\\\PharmacyMedicineReport\\\\StatusReport.txt"))) {
                writer.write("");
                System.out.println("Status Report Cleared");
            } catch (IOException ex) {
                System.out.println("Error : " + ex.getMessage());
            }
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        // TODO add your handling code here:
        String metin = txtAssignmet.getText();
        try ( BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\fener\\OneDrive\\Masaüstü\\PharmacyMedicineReport\\Assignment.txt"))) {
            writer.write(metin);
    ...
    private javax.swing.JButton btnSellMedicine1;
    ...
    private javax.swing.JTextField txtAssignmet;
